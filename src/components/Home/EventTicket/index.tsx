            ...
            <section className="dark:bg-darkmode pt-0">
                <div className="container">
                    <div className="text-center md:pb-20 pb-8">
                        <h2 className="pb-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">E já está perto de acontecer!</h2>
                        <p data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000" className="text-SlateBlueText dark:text-opacity-80 text-lg font-normal max-w-920 m-auto">
                            Garanta já o seu ingresso para o evento mais aguardado do ano! Não perca a oportunidade de fazer parte dessa experiência única e inesquecível. Adquira seu ticket agora e prepare-se para momentos incríveis!
                        </p>
                    </div>
