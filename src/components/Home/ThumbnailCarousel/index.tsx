        ...
        <>
            <div>
                <Slider {...settingsFor} ref={mainSliderRef} className="pb-3">
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_2.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_4.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_5.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_6.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_7.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/images/ThumbnailSlider/Slider_8.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
