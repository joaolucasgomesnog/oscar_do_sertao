...
const Header: React.FC = () => {
  ...
  return (
    ...
    <header
      className={`fixed  top-0 py-1  z-50 w-full  transition-all   ${
        sticky || pathUrl !== "/" ? "shadow-lg dark:shadow-darkmd bg-[#8B0000] " : "shadow-none"
      }`}
    >
        ...
        <div className="flex items-center justify-between py-2 ">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="h-8 w-8 items-center justify-center text-body-color duration-300 dark:text-white hidden"
            >
              <svg
                viewBox="0 0 16 16"
            ...
            <Link
              href="#"
              className="hidden lg:block bg-transparent border border-solid border-white text-white px-4 py-2 rounded-lg hover:text-white"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-white text-dark px-4 py-2 rounded-lg hover:bg-gray-100"
              onClick={() => {
                setIsSignUpOpen(true);
              }}
            >
              <span className="!py-2 !px-4">Participar</span>
            </Link>
            {isSignUpOpen && (
              <div
                ref={signUpRef}
